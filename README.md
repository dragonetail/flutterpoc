...
3. 在blocs目录下面上右键菜单【Bloc： new bloc】（第二部插件提供功能），输入bloc名字为counter，将创建如下：
...
4. 在blocs下面创建blocs.dart和simple_bloc_delegate.dart，结果文件列表：
...
6. blocs下面blocs.dart和simple_bloc_delegate.dart：
...
- 参考追加其他Bloc的示例
- 导入SQL工程示例（<https://medium.com/flutter-community/using-sqlite-in-flutter-187c1a82e8b）
